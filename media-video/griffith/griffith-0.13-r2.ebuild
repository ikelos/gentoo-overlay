...
inherit versionator python-single-r1 multilib git-r3

ARTWORK_PV="0.9.4"

DESCRIPTION="Movie collection manager"
HOMEPAGE="http://www.griffith.cc/"
SRC_URI="https://dev.gentoo.org/~hwoarang/distfiles/${PN}-extra-artwork-${ARTWORK_PV}.tar.gz"
EGIT_REPO_URI="https://github.com/santiavenda2/griffith"
LICENSE="GPL-2"
SLOT="0"
